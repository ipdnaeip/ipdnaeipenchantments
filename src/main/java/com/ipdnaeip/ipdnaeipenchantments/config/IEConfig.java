...
public class IEConfig {
    ...
    public IEConfig(final ForgeConfigSpec.Builder builder) {
        ...
        this.drawReduceDamage = builder.comment("Should the damage of draw arrows be reduced to account for the increased damage due to increased velocity:").translation("draw_reduce_damage").define("draw_reduce_damage", true);
